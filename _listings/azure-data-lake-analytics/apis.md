...
- name: Azure Data Lake Analytics API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/schema/master/_listings/azure-data-lake-analytics/catalog-usql-databases-databasename-schemas-get.md
x-common:
